...
<body>
  <div class="container">
    ...
    <!-- BODY -->
    <p class="body-text">
      One last step to start coding — confirm your email address.
    </p>
    ...
    <div class="feature-highlight">
      ...
      <div class="detail">
        Save pens, fork anything, and share your work with the world.<br />
        <span style="color: #6A6A6F; font-size: 12px;">No credit card required. Ever.</span>
      </div>
    </div>
