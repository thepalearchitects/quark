export function getNewLoginAlertEmailHtml(
  userName: string,
  ipAddress: string,
  userAgent: string,
  location?: string,
...
<head>
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .security-box .detail .key {
      color: #8A8A8F;
    }
    
    .security-box .detail .value {
      color: #EBEBEF;
    }
...
<body>
  <div class="container">
    ...
    <!-- BODY -->
    <p class="body-text">
      We noticed a new login to your Quark account. If this was you, you're all set.
    </p>
    <p class="body-text">
      If this wasn't you, <span class="highlight">secure your account immediately</span>.
    </p>
    ...
    <div class="security-box">
      ...
      <div class="detail">
        <div><span class="key">IP address</span> — <span class="value">${ipAddress}</span></div>
        ${location ? `<div><span class="key">Location</span> — <span class="value">${location}</span></div>` : ''}
        <div><span class="key">Device</span> — <span class="value">${userAgent}</span></div>
        ${loginTime ? `<div><span class="key">Time</span> — <span class="value">${loginTime}</span></div>` : ''}
      </div>
    </div>
