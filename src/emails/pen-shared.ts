export function getPenSharedEmailHtml(
  userName: string,
  penTitle: string,
  penUrl: string,
...
<body>
  <div class="container">
    ...
    <!-- BODY -->
    <p class="body-text">
      Your pen <span class="highlight">"${penTitle}"</span> is now live and shareable with the world.
    </p>
    
    <!-- PEN CARD -->
    <div class="pen-card">
      <div class="pen-title">${penTitle}</div>
      ${penDescription ? `<div class="pen-description">${penDescription}</div>` : ''}
      <div class="pen-meta">Public pen — forkable by anyone</div>
    </div>
    
    <p class="body-text">
      Anyone can view it without an account. If they want to save it, they'll need to sign up.
    </p>
    
    <!-- CTA -->
    <div class="btn-wrapper">
      <a href="${penUrl}" class="btn">View pen →</a>
      <a href="${penUrl}?embed" class="btn-secondary">Get embed code</a>
    </div>
